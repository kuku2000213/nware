...
<link rel = "stylesheet"  href= "<%= request.getContextPath() %>/resources/css/login2.css" type = "text/css">
</head>
		...
		<div class="cont_centrar">
			...
			<div class="cont_login">
				<div class="cont_info_log_sign_up">
					<div class="col_md_login">
						<div class="cont_ba_opcitiy">
							...
							<button class="btn_login" onclick="cambiar_login()" style = "outline : none;">LOGIN</button>
						</div>
					</div>
				...
				<div class="cont_forms">
					...
					<form class="cont_form_login" id = "choiLoginForm" action = "/login" method = "post">
						<a href="#" onclick="ocultar_login_sign_up()"><i
							class="material-icons">&#xE5C4;</i></a>
						<h2>LOGIN</h2>
						<input type="text" placeholder="username" name = "username" /> <input type="password"
							placeholder="Password" name = "password"/>
						<button class="btn_login" onclick="cambiar_login()" id = "choiLoginBtn"  style = "outline : none;">LOGIN</button>
						<sec:csrfInput/>
					...
					<form class="cont_form_sign_up" id = "choiSignUpForm">
						...
						<button class="btn_sign_up" onclick="cambiar_sign_up()" id = "choiSignUpBtn">SIGN
							UP</button>
